...
\label{sec:Disequg}Iniziamo con un po' di vocabolario. La tabella~\vref{tab:disuguaglianze} mostra le possibili disuguaglianze\index{Disuguaglianza} e il modo corretto di  leggerle.
\begin{table}
\centering
\begin{tabular}{lcll}
	\toprule
...
Una disuguaglianza\index{Disuguaglianza} è un confronto fra due quantità. Ovviamente è vera o è falsa.

Consideriamo l'esempio~\vref{fig:DisPgradoesempio1a},partendo da una disuguaglianza vera, sommando la stessa quantità positiva a sinistra e a destra, otteniamo una disuguaglianza ancora vera.

Analogo discorso con l'esempio~\vref{fig:DisPgradoesempio1b}. In questo caso la disuguaglianza si mantiene vera, sommando una quantità negativa.
...
\begin{figure}
	\begin{NodesList}
		...
		\end{align*}
		\tikzset{LabelStyle/.style = {left=0.1cm,pos=0.5,text=red,fill=white}}
		\LinkNodes{\begin{minipage}[h]{5cm}
...
\LinkNodes{%\begin{minipage}[h]{6cm}
Sommo
%\end{minipage}
}%
\LinkNodes{%\begin{minipage}[h]{5cm}
...
\begin{figure}
	...
	\begin{subfigure}[]{\linewidth}
		\begin{NodesList}
			\begin{align*}
				2-x\geq 0&\AddNode\\[.5cm]%
				-x\geq-2&\AddNode\\[.5cm]%
				x\leq 2&\AddNode%
			\end{align*}
			\tikzset{LabelStyle/.style = {left=0.1cm,pos=0.5,text=red,fill=white}}
			\LinkNodes{sposto $2$}%
			\LinkNodes{cambio di segno}%
		\end{NodesList}
...
\begin{figure}
	...
	\begin{subfigure}[]{\linewidth}
		\begin{NodesList}
			\centering
			\begin{align*}
				\dfrac{2}{3}-x\geq& 0\AddNode\\[.5cm]
				-x\geq&-\dfrac{2}{3}\AddNode\\[.5cm]
				x\leq& \dfrac{2}{3}\AddNode
			\end{align*}
			%\LinkNodes{Sposto $2x$ a sinistra e cambio di segno}%
				\tikzset{LabelStyle/.style = {left=0.1cm,pos=0.5,text=red,fill=white}}
			\LinkNodes{Sposto $\frac{2}{3}$}%
			\LinkNodes{Ottengo}%
		\end{NodesList}
		\caption{Risoluzione disequazione}
		\label{svo:ProDis3c}
