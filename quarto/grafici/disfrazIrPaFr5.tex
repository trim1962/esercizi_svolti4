...
xtick={-0.0,1.0,...,10.0},
ytick={-0.0,1.0,...,3.0},]
\draw[pattern=north west lines] (0,0) rectangle (4,1.0);
\draw[pattern=north west lines] (6,0) rectangle (10,1.0);
...
%\draw  (8.,2.)-- (10.,2.);
\draw [dash pattern=on 2pt off 2pt] (0.,1.)-- (4.,1.);
\draw  (4.,1.)-- (6.,1.);
\draw [dash pattern=on 2pt off 2pt] (6.,1.)-- (10.,1.);
\begin{scriptsize}
...
\draw  (4.,1.) circle (1.5pt);
\draw [fill=black] (6.,1.) circle (1.5pt);
\draw (1.0,0.37) node {$-$};
\draw (3.0,0.37) node {$-$};
\draw (5.0,0.37) node {$\oplus$};
\draw (7.0,0.37) node {$-$};
\draw (9.0,0.37) node {$-$};
\end{scriptsize}
\end{axis}
