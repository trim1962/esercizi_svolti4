...
\begin{sidewaysfigure}
	\begin{subfigure}[b]{.5\textheight}
		\centering
\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaMaggioreDiZeroAmaggioreDizero}
		\caption{$\Delta>0$ $a>0$}\label{graf:dis2GDeltaMagZa2xa}
	\end{subfigure}%
\quad
	\begin{subfigure}[b]{.5\textheight}
		\centering
	\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaMaggioreDiZeroAminoreDizero}
		\caption{$\Delta>0$ $a<0$}\label{graf:dis2GDeltaMagZb2xa}
	\end{subfigure}
\vskip .8cm
	\begin{subfigure}[b]{.5\textheight}
		\centering
		\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaUgualeaZeroAmaggioreDizero}
		\caption{$\Delta=0$ $a>0$}\label{graf:dis2GDeltaUguaZa2xa}
			\end{subfigure}%
\quad
	\begin{subfigure}[b]{.5\textheight}
		\centering
		\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaUgualeaZeroAminoreDizero}
		\caption{$\Delta=0$ $a<0$}\label{graf:dis2GDeltaUguaZb2xa}
	\end{subfigure}
\vskip .8cm
\begin{subfigure}[b]{.5\textheight}
	\centering
		\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaMinoreZeroAmaggioreDizero}
	\caption{$\Delta<0$ $a>0$}\label{graf:dis2GDeltaMinorZa2xa}
\end{subfigure}%
\quad
\begin{subfigure}[b]{.5\textheight}
	\centering
\includestandalone[width=0.7\textwidth]{quarto/DisSecGrado/DeltaMinoreZeroAminoreDizero}
